...
const NewTweet = () => {
    ...
    React.useEffect(() => {
        input.current.addEventListener("input",function (e){
            setTweet(textRender(e.target.innerText))
    ...
    return (
        <div className={classes.newTwittBox}>
            <Grid container direction={"row"}>
                ...
                <div dangerouslySetInnerHTML={{__html: tweet}} ref={input} contentEditable  data-placeholder={"تایپ کن..."} className={classNames(classes.newTwittInput,"contenteditable")}/>
            </Grid>
